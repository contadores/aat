	...
	<div class="box">
		<div class="nav-tabs-custom">
			...
			<ul class="nav nav-tabs pull-right">
				<li class="descargar_documento"><a id="a_ComparativaBimestral" href="#"><b> &nbsp;&nbsp; <i class="fa fa-download"></i> &nbsp; DESCARGAR &nbsp;&nbsp; </b></a></li>
				<li class="active"><a href="#tab_1" data-toggle="tab"><i class="fa fa-search-plus"></i> &nbsp; VISTA DETALLADA </a></li>
				<li><a href="#tab_2" data-toggle="tab"><i class="fa fa-search"></i> &nbsp; VISTA SIMPLE </a></li>
				<li><a href="#tab_3" data-toggle="tab"><i class="fa fa-file-text-o"></i> &nbsp; IDSE BIMESTRAL </a></li>
				<li><a href="#tab_4" data-toggle="tab"><i class="fa fa-file-text-o"></i> &nbsp; IDSE MENSUAL </a></li>
				<li><a href="#tab_5" data-toggle="tab"><i class="fa fa-file-text-o"></i> &nbsp; SUA BIMESTRAL</a></li>
				<li><a href="#tab_6" data-toggle="tab"><i class="fa fa-file-text-o"></i> &nbsp; SUA MENSUAL</a></li>
			</ul>
			<div class="tab-content">
			<br>
			<?php ///////////////////////////////////////////////////////////////////////////////////////// target='_blank' enctype="multipart/form-data" ?>
				<div class="tab-pane active table-responsive" id="tab_1">	<!-- VISTA DETALLADA -->
			...
			<?php ///////////////////////////////////////////////////////////////////////////////////////// target='_blank' enctype="multipart/form-data" ?>
				<div class="tab-pane" id="tab_2">	<!-- VISTA SIMPLE -->
							<table class="table table-bordered table-striped dataTables">
								<thead>
										<tr>
												<th>NSS</th>
